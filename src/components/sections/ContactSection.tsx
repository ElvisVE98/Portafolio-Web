 ...
 * ContactSection.tsx
 * ============================================================================
 * Sección de Contacto con gradiente ambiental púrpura continuo hacia el Footer.
 * Estilo unificado con el tema Purple / Fuchsia del Navbar.
 * ============================================================================
 */
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="py-14 px-6 sm:px-12 rounded-3xl bg-[#120a1f]/85 border border-purple-500/20 shadow-2xl shadow-purple-950/40 backdrop-blur-2xl">
          ...
          <p className="text-zinc-300 text-sm sm:text-base max-w-xl mx-auto mb-8 leading-relaxed font-light">
            Actualmente resido en <strong className="text-white font-semibold">{PERSONAL_DATA.location}</strong> y estoy {PERSONAL_DATA.availability}
          </p>
