...
/**
 * Declaración del tipo global `feather`.
 *
 * `feather` viene del CDN (unpkg.com/feather-icons) y no tiene
 * un paquete de tipos (@types/feather-icons) instalado.
 * Con `declare const` le decimos a TypeScript:
 * "confía en mí, esta variable existe como global en tiempo de ejecución".
 * Esto evita el error "Cannot find name 'feather'".
 */
